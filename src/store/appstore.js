...
const store = new Vuex.Store({
  state: {
    ...
    markers: [
      ...
      },
      {
        ...
        description: {
          overView: [
            '这座现代化的物流中心位于嘉兴市内，可租赁面积81,600平方米，包括四栋单层仓库。',
          ],
          accessibilities:
      ...
      },
      {
        ...
        description: {
          overView: [
            '该物流中心是安博在中国的首个机场物流中心，标志着安博首次进驻中国华北地区市场。',
          ],
          accessibilities:
  ...
  mutations: {
    ...
    setUserCoordinates(state, userCoordinates) {
      ...
      state.userCoordinates.userLatitude = userCoordinates.userLatitude;
      state.userCoordinates.userLongitude = userCoordinates.userLongitude;
    },
