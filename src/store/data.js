const centers = [
  // East China
  {
    id: 1,
    latitude: 31.185916,
    longitude: 121.153641,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '上海',
    centerName: '安博上海青浦配送中心',
    address: '上海市青浦工业园新团路518号',
    area: '81,800',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    accessibilities: [
      ...
      {
        destination: '距外高桥集装箱码头',
        distance: '57',
      },
      {
        destination: '距洋山国际深水港',
        distance: '100',
      },
    ],
  ...
  },
  {
    id: 2,
    latitude: 31.141716,
    longitude: 121.332576,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '上海',
    centerName: '安博上海九亭物流中心',
    address: '上海市松江区伴亭路418号',
    area: '35,000',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    description: {
      overView: [
        '该物流中心位于上海松江区，包括两栋高品质仓库和一栋办公楼，符合国际标准建造而成，可租赁面积35,000 平方米，充分满足集装箱处理和配送服务的需要。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '至G92高速公路',
        distance: '5',
      },
      {
        destination: '至G15和S20高速公路',
        distance: '6',
      },
      {
        destination: '距上海市中心',
  ...
  },
  {
    id: 3,
    latitude: 30.87625,
    longitude: 121.336757,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '上海',
    centerName: '安博上海金山物流中心',
    address: '上海市金山工业区金腾路（近林贤路)',
    area: '45,200',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    description: {
      overView: [
        '该现代化配送中心位于上海金山，2015年竣工，包括两栋甲级仓库，可租赁面积45,200平方米。现场驻有安博的专业物业管理团队，以确保客户业务的顺利运营。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距G1501上海郊环线',
        distance: '0.5',
      },
      {
        destination: '距G15沈海高速',
        distance: '1',
      },
    ],
  ...
  },
  {
    id: 4,
    latitude: 31.363617,
    longitude: 120.544119,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '苏州',
    centerName: '安博苏州金阊物流中心',
    address: '江苏省苏州市姑苏区金阊新城',
    area: '108,000',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    description: {
      overView: [
        '苏州金阊物流中心于2016年竣工，是该地区首个现代化多层仓储设施。该物业位于苏州姑苏区金阊新城，可租赁面积108,000平方米，包括三栋多层仓库，每个库房分割成多个单元。',
      ],
      accessibilities:
  ...
  },
  {
    id: 5,
    latitude: 31.405128,
    longitude: 120.541231,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '苏州',
    centerName: '安博苏州浒关物流中心',
    address: '江苏省苏州国家高新技术产业开发区',
    area: '45,300',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    distance: '',
    avatar: 'https://cdn.prologis.site/images/east_china/suzhou_xuguan/icon.jpg',
    swiper: {
      images: [
        'https://cdn.prologis.site/images/east_china/suzhou_xuguan/photo1.JPG',
        'https://cdn.prologis.site/images/east_china/suzhou_xuguan/photo2.jpg',
    ...
    description: {
      overView: [
        '该物流中心位于苏州国家高新工业开发区，可租赁面积45,300平方米，采用反射式屋顶，以减轻了城市热岛效应。',
      ],
      accessibilities:
  ...
  },
  {
    id: 6,
    latitude: 31.33383,
    longitude: 121.082333,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '昆山',
    centerName: '安博昆山陆家物流中心',
    address: '江苏省昆山市陆家镇金阳东路与望石路交叉口',
    area: '43,800',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    description: {
      overView: [
        '该现代化物流园由两栋单层仓库组成，可租赁面积43,800平方米。',
        '该物流中心依照国际标准建造而成。合理的窗户和天窗设置使其能够高效地利用自然光，从而在美化了工作环境的同时也极大的降低了照明成本。',
      ],
      accessibilities:
  ...
  },
  {
    id: 7,
    latitude: 31.572941,
    longitude: 120.438937,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '无锡',
    centerName: '安博无锡梅村物流中心',
    address: '无锡新区梅村工业集中区',
    area: '132,000',
    phoneNumber: {
      areaCode: '159',
    ...
    description: {
      overView: [
        '该物流中心位于无锡梅村工业附属区，可租赁面积132,000 平方米，距无锡市中心和上海虹桥机场各为10公里和110公里，是城市配送的理想选择。',
      ],
    ...
    accessibilities: [
      ...
      {
        destination: '距G42沪宁高速(苏南硕放机场出入口)',
        distance: '7',
      },
      {
        destination: '距无锡机场',
  ...
  },
  {
    id: 8,
    latitude: 31.779021,
    longitude: 118.820506,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '南京',
    centerName: '安博南京空港物流中心',
    address: '南京市江宁空港枢纽经济区',
    area: '83,100',
    phoneNumber: {
      areaCode: '159',
      part1: '2180',
    ...
    description: {
      overView: [
        '该物流中心位于江宁开发区，是南京最重要的生产基地之一，可租赁面积达83,100平方米。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距南京禄口机场',
        distance: '17', // 20-minutes drive
      },
      {
        destination: '距S55南京机场高速',
        distance: '4',
      },
    ],
  ...
  },
  {
    id: 9,
    latitude: 32.28423,
    longitude: 118.773981,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '南京',
    centerName: '安博南京六合物流中心',
    address: '南京市六合经济开发区',
    area: '103,100',
    phoneNumber: {
      areaCode: '159',
    ...
    description: {
      overView: [
        '该物流中心地处南京市六合经济开发区，可租赁面积103,100平方米，包括四栋双层库，将于2021年一季度建成。',
      ],
      accessibilities:
  ...
  },
  {
    id: 10,
    latitude: 30.450949,
    longitude: 120.085219,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '杭州',
    centerName: '安博杭州仁和物流中心',
    address: '杭州市余杭区仁和街道',
    area: '76,200',
    phoneNumber: {
      areaCode: '159',
    ...
    accessibilities: [
      ...
      {
        destination: '距沪杭高铁余杭站',
        distance: '20',
      },
      {
        destination: '距G25长深高速',
        distance: '2',
      },
      {
        destination: '距G60沪昆高速',
        distance: '20',
      },
      {
        destination: '距宁波',
  ...
  },
  {
    id: 11,
    latitude: 30.73148,
    longitude: 120.422982,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '湖州',
    centerName: '安博湖州练市物流中心',
    address: '浙江湖州练市镇工业园区',
    area: '86,300',
    phoneNumber: {
      areaCode: '159',
    ...
    description: {
      overView: [
        '该物流中心地处浙江省湖州练市镇工业园区，可租赁面积86,300平方米，包括两栋双层库，将于2021年一季度建成。',
      ],
      accessibilities:
  ...
  },
  {
    ...
    description: {
      overView: ['这座现代化的物流中心位于嘉兴市内，可租赁面积81,600平方米，包括四栋单层仓库。'],
      accessibilities:
  ...
  },
  {
    id: 13,
    latitude: 30.348878,
    longitude: 114.385939,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华东区',
    city: '武汉',
    centerName: '安博武汉江夏物流中心',
    address: '武汉江夏庙山开发区',
    area: '203,000',
    phoneNumber: {
      areaCode: '159',
    ...
    distance: '',
    avatar: 'https://cdn.prologis.site/images/east_china/wuhan_jiangxia/icon_Wuhan_Jiangxia.jpg',
    swiper: {
    ...
    description: {
      overView: [
        '武汉江夏物流中心包括5栋现代化双层建筑，将分两期竣工。一期预计将于2019年第二季度建成，可租赁面积将超过121,000平方米。二期可租赁面积将达到82,000平方米。该物流中心经庙山路到武昌市中心仅20分钟车程。',
      ],
      accessibilities: '该物流中心位于江夏开发区内，毗邻光谷，是汽车、医药和电子产品的制造基地。',
    },
    plans: [
  ...
  },
  {
    ...
    description: {
      overView: [
        '该物流中心毗邻武昌，位于武汉地区的物流分市场鄂州市，可租赁面积51,000平方米，包括两栋单层仓库。',
      ],
      accessibilities:
  ...
  },
  {
    ...
    description: {
      overView: [
        '该物流中心分两期建设。 第一期计划于2019年第二季度完工，由两栋单层仓库组成，将提供49,900平方米的现代物流空间。 第二期工程计划包括两栋双层库，将提供71,600平方米的现代物流空间。项目距离武汉市中心仅25公里。',
        '园区位于蔡甸经济开发区，毗邻武汉经济开发区，均为汽车、汽车零部件和高新技术产业的制造基地。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距离三环路(武汉市区)',
        distance: '25',
      },
      {
        destination: '距离武汉天河机场',
        distance: '56',
      },
    ],
  ...
  // North China
  {
    id: 16,
    latitude: 40.135305,
    longitude: 116.608124,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '北京',
    centerName: '安博北京首都机场第二物流中心',
    address: '近北京市空港物流园区',
    area: '96,100',
    phoneNumber: {
      areaCode: '185',
    ...
    description: {
      overView: [
        '该物流中心位于北京首都国际机场，是中国首个多层机场物流中心。可租赁面积超过96,100平方米，包括两栋多层建筑，是中国最大的电子商务区域配送中心。',
      ],
      accessibilities:
  ...
  },
  {
    id: 17,
    latitude: 40.132915,
    longitude: 116.595629,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '北京',
    centerName: '安博北京首都机场第一物流中心',
    address: '北京市顺义区顺航路12号',
    area: '28,100',
    phoneNumber: {
      areaCode: '185',
      part1: '1441',
    ...
    swiper: {
      images: ['https://cdn.prologis.site/images/north_china/beijing_capital_airport_1/photo.jpg'],
      video: '',
    },
    description: {
      overView: ['该物流中心是安博在中国的首个机场物流中心，标志着安博首次进驻中国华北地区市场。'],
      accessibilities:
  ...
  },
  {
    id: 18,
    latitude: 39.257583,
    longitude: 117.441397,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '天津',
    centerName: '安博天津宁河物流中心',
    address: '天津未来科技城现代产业区',
    area: '136,600',
    phoneNumber: {
      areaCode: '185',
      part1: '1441',
    ...
    description: {
      overView: [
        '该物流中心获美国LEED绿色建筑银级认证，是安博中国第二个由美国LEED绿色建筑认证的园区，包括六栋物流仓库，可租赁面积136,600平方米。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距离天津空港经济开发区',
        distance: '8',
      },
      {
        destination: '距离天津经济技术开发区',
        distance: '35',
      },
    ],
  ...
  },
  {
    id: 19,
    latitude: 39.546054,
    longitude: 116.833537,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '天津',
    centerName: '安博天津京滨物流中心',
    address: '天津京滨工业园(紧邻廊坊经济开发区)',
    area: '56,300',
    phoneNumber: {
      areaCode: '185',
      part1: '1441',
    ...
    description: {
      overView: [
        '天津京滨物流中心位于京津冀地区的核心区域，距北京六环20分钟车程，距北京市区约40分钟车程。该物流中心于2015年竣工，可租赁面积56,300平方米，包括三栋建筑，其建造符合最高国际标准。',
      ],
      accessibilities:
  ...
  // Has no PDF file
  {
    ...
    description: {
      overView: [
        '该物流中心可租赁面积18,600平方米，由两个相同面积仓库组成，是存储、调运或生产制造进口产品的免税仓库。',
      ],
      accessibilities:
  ...
  },
  {
    id: 21,
    latitude: 41.743255,
    longitude: 123.565201,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '沈阳',
    centerName: '安博沈阳浑南物流中心',
    address: '沈阳浑南新区电子商务物流产业园',
    area: '96,100',
    phoneNumber: {
      areaCode: '185',
      part1: '1154',
  ...
  },
  {
    id: 22,
    latitude: 41.783682,
    longitude: 123.201433,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '沈阳',
    centerName: '安博沈阳于洪物流产业园',
    address: '沈阳市于洪区',
    area: '187,600',
    phoneNumber: {
      areaCode: '185',
    ...
    description: {
      overView: [
        '该物流园区建成后， 将由八栋单层现代化物流仓储设施组成，可租赁面积超过两百万平方英尺。 一期预计2019年第二季度竣工，可租赁面积69,400平方米。 二期预计2020年底竣工，可租赁面积118,200平方米。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '位于西四环路与京哈高速(G1)交叉口',
        distance: '',
      },
      {
        destination: '距离沈阳机场',
  ...
  },
  {
    id: 23,
    latitude: 36.797367,
    longitude: 117.218659,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '济南',
    centerName: '安博济南高新国际物流园',
    address: '济南市高新技术产业开发区',
    area: '143,100',
    phoneNumber: {
      areaCode: '185',
      part1: '1441',
    ...
    description: {
      overView: [
        '该物流中心地处济南市高新技术产业开发区，分二期建设。一期包含4栋单层库，租赁面积为69,900平米，将于2019年第四季度建成；二期包含3栋单层库，租赁面积为73,200平米，将于2020年第三季度建成。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距离京沪高速(G2)郭店收费站',
        distance: '8',
      },
      {
        destination: '距离青银高速(G20)/济南绕城高速(G2001)遥墙收费站',
        distance: '3.5',
      },
      {
        destination: '距离济南机场',
  ...
  },
  {
    id: 24,
    latitude: 36.831562,
    longitude: 116.801663,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华北区',
    city: '济南',
    centerName: '安博齐河国际物流园',
    address: '德州市齐河经济开发区',
    area: '143,400',
    phoneNumber: {
      areaCode: '185',
    ...
    description: {
      overView: [
        '该物流中心地处德州市齐河经济开发区，预计2020年二季度建成，包含6栋单层库，可租赁面积143,400平方米',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距离青银高速(G20)/济南绕城高速(G2001)齐河东收费站',
        distance: '4.7',
      },
    ],
  ...
  // West China
  {
    id: 25,
    latitude: 30.556527,
    longitude: 103.981236,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '成都',
    centerName: '安博成都空港物流中心',
    address: '成都市双流县成都国际航空枢纽综合功能区物流大道',
    area: '59,700',
    phoneNumber: {
      areaCode: '151',
      part1: '0281',
    ...
    description: {
      overView: [
        '该物流中心位于成都机场物流区，可租赁面积59,700平方米，包括三栋单层仓库，是最优质的分市场物流设施建筑。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距G4201(成都绕城)高速公路',
        distance: '7',
      },
      {
        destination: '距G76(厦蓉)高速公路',
        distance: '20',
      },
      {
        destination: '距G42(沪蓉)高速公路',
        distance: '25',
      },
      {
        destination: '距成都双流国际机场',
        distance: '2',
      },
      {
        destination: '距市中心',
  ...
  },
  {
    id: 26,
    latitude: 30.523693,
    longitude: 104.203663,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '成都',
    centerName: '安博成都龙泉物流中心',
    address: '成都市龙泉物流园区',
    area: '262,400',
    phoneNumber: {
      areaCode: '151',
    ...
    description: {
      overView: [
        '该物流中心由七栋两层仓库组成，可租赁面积262,400平方米，位于成都市东南方向的龙泉物流园区和国家经济技术开发区内。该开发区是成都最大的生产制造基地，也是成渝经济走廊的入口。',
      ],
      accessibilities:
  ...
  },
  {
    id: 27,
    latitude: 30.795927,
    longitude: 104.116753,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '成都',
    centerName: '安博新都国际物流港',
    address: '成都市新都区金石园路480号',
    area: '216,100',
    phoneNumber: {
      areaCode: '182',
      part1: '0032',
    ...
    description: {
      overView: [
        '新都国际物流港共分三期完成，可租赁面积216,100平方米。该物流中心位于成都市北部的新都物流园区内，距成都三环路10分钟车程，位于传统物流区内，是成都地区卡车运输服务的主要站点。',
      ],
      accessibilities:
  ...
  },
  {
    id: 28,
    latitude: 30.826021,
    longitude: 104.272923,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '成都',
    centerName: '安博成都青白江物流中心',
    address: '四川省成都市青白江区青白江大道以东，达成铁路以西',
    area: '50,900',
    phoneNumber: {
      areaCode: '182',
      part1: '0032',
    ...
    description: {
      overView: [
        '该现代化物流中心位于四川省成都市青白江区内达成铁路西侧和青白江大道东侧，由三个仓库组成，竣工之后可租赁面积超过50,900平方米。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距G5(京昆)高速',
        distance: '6',
      },
      {
        destination: '距G42(沪蓉)高速',
        distance: '17',
      },
      {
        destination: '距成都铁路口岸(青白江)',
        distance: '4',
      },
      {
        destination: '距成都双流国际机场(经绕城高速)',
  ...
  },
  {
    id: 29,
    latitude: 29.661021,
    longitude: 106.794811,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '重庆',
    centerName: '安博重庆两江新区物流中心',
    address: '重庆两江新区鱼复工业园',
    area: '183,000',
    phoneNumber: {
      areaCode: '151',
    ...
    description: {
      overView: [
        '该物流中心包括4栋单层和4栋双层仓库，可租赁面积183,000平方米。该物流中心位于重庆市东北部两江新区的鱼复工业园内，距市中心 22公里，距机场14公里，距河港仅3公里。',
      ],
      accessibilities:
  ...
  },
  {
    id: 30,
    latitude: 29.802991,
    longitude: 106.685466,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '重庆',
    centerName: '安博重庆空港物流中心',
    address: '重庆江北国际机场空港物流园区',
    area: '192,300',
    phoneNumber: {
      areaCode: '188',
      part1: '8323',
    ...
    description: {
      overView: [
        '该物流中心由5栋单层和2栋双层仓库组成，竣工之后可租赁面积将超过192,300平方米，共分两期建成。该物业位于重庆市北部两江新区两路寸滩保税港区的物流市场内，市场发展迅速，但供不应求，物流园区的建成将对于物流市场大有裨益。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距G65(包茂高速)',
        distance: '9',
      },
      {
        destination: '距轻轨3号线延伸线',
        distance: '0.8',
      },
    ],
  ...
  },
  {
    id: 31,
    latitude: 29.667433,
    longitude: 106.412956,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '重庆',
    centerName: '安博重庆西部国际物流中心',
    address: '重庆市沙坪坝区，西部物流园中干东路以东、横二路以北，国际物流社区内',
    area: '164,100',
    phoneNumber: {
      areaCode: '151',
      part1: '0281',
    ...
    description: {
      overView: [
        '该物流中心由4栋双层仓库组成，分两期开发，竣工之后可租赁面积将超过164,100平方米。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距离微电园轻轨站',
        distance: '8',
      },
      {
        destination: '距离渝新欧起点站',
        distance: '2',
      },
      {
        destination: '距离G93成渝环线高速出口',
        distance: '3',
      },
      {
        destination: '距离快速路二横线',
        distance: '0.2',
      },
      {
        destination: '距离重庆核心城区',
        distance: '15',
      },
    ],
  ...
  },
  {
    id: 32,
    latitude: 34.249858,
    longitude: 108.687753,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华西区',
    city: '西安',
    centerName: '安博西安沣西物流中心',
    address: '陕西省西咸新区沣西新城，G30(南线)以南，咸户路以东，科技路以北',
    area: '253,300',
    phoneNumber: {
      areaCode: '136',
      part1: '7910',
    ...
    description: {
      overView: [
        '该物流中心预期于2020年竣工，可租赁面积将近253,300平米。整个园区包括四栋单层库和四栋双层库。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距离西安绕城高速(G3001)',
        distance: '10',
      },
      {
        destination: '距离西安咸阳国际机场',
        distance: '25',
      },
      {
        destination: '距离西咸环线高速',
        distance: '3.5',
      },
      {
        destination: '距离咸阳市区',
  ...
  },
  {
    ...
    region: '华西区',
    city: '西安',
    centerName: '安博西安国际港务区物流中心',
    address: '陕西省西安市国际港务区，潘骞路以北，纺渭路以东，综保区2期以南',
    area: '91,400',
    phoneNumber: {
      areaCode: '136',
      part1: '7910',
    ...
    description: {
      overView: [
        '该物流中心由一栋单层库和两栋双层库组成，可租赁面积91,400平方米，将于2021年建成。',
      ],
      accessibilities:
  ...
  // South China
  {
    ...
    region: '华南区',
    city: '广州',
    centerName: '安博广州开发区物流中心',
    address: '广州经济技术开发区东勤路3号',
    area: '128,000',
    phoneNumber: {
      areaCode: '184',
      part1: '7539',
  ...
  },
  {
    id: 35,
    latitude: 23.430967,
    longitude: 112.963119,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华南区',
    city: '佛山',
    centerName: '安博佛山大塘物流中心',
    address: '佛山三水工业园区大塘园',
    area: '110,400',
    phoneNumber: {
      areaCode: '184',
  ...
  },
  {
    ...
    region: '华南区',
    city: '佛山',
    centerName: '安博佛山高明物流中心',
    address: '高明区更合镇小洞工业园经一路',
    area: '151,900',
    phoneNumber: {
      areaCode: '184',
      part1: '7539',
    ...
    description: {
      overView: [
        '该物流中心位于佛山市高明区更合镇小洞工业园，可租赁面积151,900平方米，由 一栋单层库和两栋双层库（A 区）以及两栋双层库（B 区）组成，将于2021年二季度建成。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '距G94珠三角绕城高速公路',
        distance: '30',
      },
      {
        destination: '距G1501广州绕城高速公路',
        distance: '50',
      },
      {
        destination: '距佛山市中心区',
  ...
  },
  {
    ...
    description: {
      overView: [
        '此物流中心由八栋单层仓库组成，可租赁面积超过149,900 平方米。',
        '该物流中心距从莞深高速仅500米，距生态园5分钟车程，距松山湖工业园15分钟车程。',
      ],
      accessibilities:
    ...
    accessibilities: [
      ...
      {
        destination: '紧邻从莞高速, 连接广州及深圳',
        distance: '',
      },
      {
        destination: '距离东莞市中心约',
        distance: '25',
      },
      {
        destination: '距离广州市中心约',
        distance: '75',
      },
      {
        destination: '距离深圳市中心约',
        distance: '75',
      },
    ],
  ...
  },
  {
    id: 38,
    latitude: 22.971209,
    longitude: 113.622735,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华南区',
    city: '东莞',
    centerName: '安博东莞洪梅物流中心',
    address: '东莞市洪梅镇洪金路',
    area: '81,900',
    phoneNumber: {
      areaCode: '184',
    ...
    description: {
      overView: [
        '该物流中心可租赁面积81,900平方米，包括两栋双层仓库。其地理位置优越，距广深高速仅500米，是电子商务客户、零售商和制造业企业城市配送的理想选择。',
      ],
      accessibilities:
  ...
  },
  {
    id: 39,
    latitude: 22.795568,
    longitude: 114.424108,
    iconPath: '/static/images/location.png',
    width: 29,
    height: 37,
    region: '华南区',
    city: '惠州',
    centerName: '安博惠州惠阳物流中心',
    address: '惠州市惠阳区秋湖路',
    area: '272,100',
    phoneNumber: {
      areaCode: '184',
